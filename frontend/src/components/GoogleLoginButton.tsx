...
export function GoogleLoginButton({ disabled }: { disabled?: boolean }) {
  ...
  return (
    <button
      ...
      onClick={handleClick}
      disabled={disabled}
      className="w-full h-10 rounded-full bg-white border border-gray-300 text-gray-700 text-sm font-semibold flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed dark:bg-zinc-950 dark:border-zinc-700 dark:text-zinc-100"
    >
