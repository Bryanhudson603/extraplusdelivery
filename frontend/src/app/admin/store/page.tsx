...
export default function AdminStoreConfirmPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[var(--brand-soft-bg)] dark:bg-zinc-950 px-4">
      <div className="w-full max-w-sm bg-[var(--brand-soft-surface)] border border-[var(--brand-soft-border)] dark:bg-zinc-900 dark:border-zinc-800 rounded-2xl p-6 space-y-5 shadow-sm">
        ...
        <div className="space-y-1">
          <p className="text-xs text-blue-600 font-semibold uppercase tracking-wide">Confirmar loja</p>
        ...
        <div className="rounded-xl border border-gray-200 bg-gray-50 dark:border-zinc-800 dark:bg-zinc-950 p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-[11px] px-2 py-0.5 rounded-full border border-blue-500/50 text-blue-600">
              Dil Bebidas
            </span>
          </div>
