       ...
       <div className="max-w-7xl mx-auto space-y-6">
         <div className="flex items-center justify-between">
           <div className="flex items-center gap-3">
             <a href="/admin" className="text-xs text-zinc-400 hover:text-amber-400">← Voltar</a>
             <div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
           <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-4">
             <div className="text-xs text-zinc-400">Vendas no período</div>
             ...
             <table className="min-w-full text-sm">
               ...
               <tbody>
                 {loading ? (
                   ...
                   <tr>
                     <td className="px-4 py-3 text-zinc-500" colSpan={4}>Sem dados no período</td>
                   </tr>
                 ) : (
                   dias.map((d) => (
